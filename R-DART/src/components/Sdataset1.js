...

{
    ...
    setTimeout(() => {
      if(event.target.value  === "/Users/aishwaryapradeep/Desktop/demo/credit-g.csv"){
    //   setlabelcol(creditlabels);
    }
  
  else if(event.target.value  === "/Users/aishwaryapradeep/Desktop/demo/breast-cancer.csv"){
    //   setlabelcol(bcancerlabels);
    }
  else if(event.target.value  === '/Users/aishwaryapradeep/Desktop/demo/adult.csv'){
