...
const clientsecret = process.env.REACT_APP_CLIENT_SECRET;
 ...
 var globalsv_filename = '/Users/aishwaryapradeep/Desktop/Project-SAppGen/R-DART/datafolder/data.csv';
...
var options = {
  'method': 'POST',
  'url': 'https://api.ibm.com/dataquality4ai/run/data_quality/structured/class_overlap',
  'headers': {
...
exports.getclassparity = function (label = '', fpath = '', fname='') {
  ...
  return new Promise((resolve, reject) => {
    ...
    var options = {
      'method': 'POST',
      'url': 'https://api.ibm.com/dataquality4ai/run/data_quality/structured/class_parity',
      'headers': {
        'X-IBM-Client-Id': clientid,
        'X-IBM-Client-Secret': clientsecret,
        'accept': 'application/json',
...
exports.getlabelpurity = function (label = "",fpath = "", fname="") {
  ...
  return new Promise((resolve, reject) => {
    ...
    var options = {
      'method': 'POST',
      'url': 'https://api.ibm.com/dataquality4ai/run/data_quality/structured/label_purity',
      'headers': {
        'X-IBM-Client-Id': clientid,
        'X-IBM-Client-Secret': clientsecret,
        'accept': 'application/json',
...
exports.getoutlierdetection = function (label = "",fpath = "", fname="") {
  ...
  return new Promise((resolve, reject) => {
    ...
    var options = {
      'method': 'POST',
      'url': 'https://api.ibm.com/dataquality4ai/run/data_quality/structured/outlier_detection',
      'headers': {
        'X-IBM-Client-Id': clientid,
        'X-IBM-Client-Secret': clientsecret,
        'accept': 'application/json',
...
exports.chkdatacompleteness = function (fpath = "", fname = "") {
  ...
  return new Promise((resolve, reject) => {
    ...
    var options = {
      'method': 'POST',
      'url': 'https://api.ibm.com/dataquality4ai/run/data_quality/structured/data_completeness',
      'headers': {
        'X-IBM-Client-Id': clientid,
        'X-IBM-Client-Secret': clientsecret,
        'accept': 'application/json',
...
exports.chkdataduplicates = function (fpath = "", fname="") {
  ...
  return new Promise((resolve, reject) => {
    ...
    var options = {
      'method': 'POST',
      'url': 'https://api.ibm.com/dataquality4ai/run/data_quality/structured/data_duplicates',
      'headers': {
        'X-IBM-Client-Id': clientid,
        'X-IBM-Client-Secret': clientsecret,
        'accept': 'application/json',
...
exports.chkdatahomogeneity = function (fpath = "", fname="") {
  ...
  return new Promise((resolve, reject) => {
    ...
    var options = {
      'method': 'POST',
      'url': 'https://api.ibm.com/dataquality4ai/run/data_quality/structured/data_homogeneity',
      'headers': {
        'X-IBM-Client-Id': clientid,
        'X-IBM-Client-Secret': clientsecret,
        'accept': 'application/json',
...
exports.chkdataprofile = function (fpath = "", fname="") {
  ...
  return new Promise((resolve, reject) => {
    ...
    var options = {
      'method': 'POST',
      'url': 'https://api.ibm.com/dataquality4ai/run/data_quality/structured/data_profiler',
      'headers': {
        'X-IBM-Client-Id': clientid,
        'X-IBM-Client-Secret': clientsecret,
        'accept': 'application/json',
...
exports.getresults = function (jobid = "") {
 ...
 jobid = jobid.toString();
  ...
  return new Promise((resolve, reject) => {
    ...
    var options = {
      'method': 'POST',
      'url': 'https://api.ibm.com/dataquality4ai/run/get_result',
      'headers': {
        'X-IBM-Client-Id': clientid,
        'X-IBM-Client-Secret': clientsecret,
        'accept': 'application/json',
...
//   var csv = '/Users/aishwaryapradeep/Desktop/demo/credit-g.csv'

//     fs.readFile(csv, async (error, data) => {
//       if (error) {
