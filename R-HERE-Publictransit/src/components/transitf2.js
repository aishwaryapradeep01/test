  ...
  const handleSubmit = (e) => {
    ...
    if (location && radius) {
        ...
        try{
            ...
            const locstr = [result.items[0]["position"]["lat"].toString(),result.items[0]["position"]["lng"].toString()].toString().concat(";r=").concat(radius);
          ...
          if(JSON.stringify(result.boards) === '[]'){
           ...
           if(result.hasOwnProperty('title')){
            //alert('Invalid input. Radius must be in range of 0-999999999 metres');
            seterr4status(true); 
            setGeocodeobj({});
          }
      ...
      //alert('Location, Radius values should not be empty');
      seterr1status(true);
      setLoading(false);
    }
  };
              ...
              <TableContainer title="Public Transit Results">
                ...
                return (
                      ...
                      <TableRow key={index} >
                        ...
                        {/* <TableCell> <Button type="submit" onClick={() => departureSubmit(index)} > List Departures </Button> </TableCell> */}
              ...
              <TableContainer title="Destination Results">
                ...
                return (
                      ...
                      <TableRow key={index} >
                        ...
                        {/* <TableCell>{row.time.length}</TableCell> */}
                        <TableCell>{capitalize(row.transport.mode)}</TableCell>
                        {/* <TableCell>{row.transport.mode.length}</TableCell> */}
                        <TableCell>{row.transport.headsign}</TableCell>
                        {/* <TableCell>{row.transport.headsign.length}</TableCell> */}
                      </TableRow>
